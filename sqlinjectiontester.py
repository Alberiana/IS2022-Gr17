...
# Butoni CHECK
tk.Button(master, fg="#ffffff", bg="#001f3f", width=12, font=(None, 13), text="CHECK", command=check_injection).grid(
    row=2, column=1, padx=(0, 190), pady=(15, 0))
# Butoni CLEAR
tk.Button(master, fg="#ffffff", bg="#001f3f", width=12, font=(None, 13), text="CLEAR", command=clear_clicked).grid(
